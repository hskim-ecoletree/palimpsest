...
///
/// S0 에서 이 타입은 장식이 아니라 하중을 진다. 지원 언어가 다섯인데
/// (Kotlin·Java·JavaScript·TypeScript·Rust — 지시 2026-08-12 §1 · 2026-08-20 §1)
/// 추출기는 셋뿐이라,
/// 나머지 둘에서 빈 목록을 내면 *"선언이 없는 파일"* 과 *"이 빌드가 그 언어를 모른다"* 가
/// 구별되지 않는다.
