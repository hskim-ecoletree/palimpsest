...
//!
//! # 왜 값이 넷이고 다섯이 아닌가 ([DESIGN §3](../../../docs/DESIGN.md))
//!
...
///
/// # 불변이다 ([DESIGN §3.1](../../../docs/DESIGN.md))
///
...
///
/// # 출처의 중복이 아니다 ([DESIGN §3.4](../../../docs/DESIGN.md))
///
...
/// 엣지 해소 등급 — **엣지에 자격을 박는다** ([DESIGN §5.1](../../../docs/DESIGN.md)).
///
...
impl ResolutionGrade {
    ...
    ///
    /// [DESIGN §5.1](../../../docs/DESIGN.md) 의 등급표는 출처 열에 `exact`·`scoped`·
