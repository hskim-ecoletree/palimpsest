...
//!
//! [DESIGN §3.1](../../../docs/plan/disposal-map.md)이 *"출처 필드는 불변이고 승격은 새 노드 생성"*
...
/// 재현 입력 — **`extracted` 사실은 자기 재현 입력을 실어야 한다** ([DESIGN §3](../../../docs/plan/disposal-map.md)).
///
/// # 커밋 하나가 아니다 (U14-c)
///
...
impl DerivedId {
    ...
    /// 무엇에 대한 것인가, 나머지 셋이 [DESIGN §1.2 D33](../../../docs/plan/disposal-map.md)이
    /// 못 박은 성분이다.
    ///
    /// # 길이를 앞에 붙이는 이유
    ///
