//! 판정 산출 — **3분할이고 `clean` 이 없다** ([DESIGN §8](../../../docs/plan/disposal-map.md) · D9).
//!
//! ```text
...
//! **같은 것을 두 번 두지 않는다.**
//!
//! # 잔여는 목록이 아니라 결박물이다 ([DESIGN §8.1](../../../docs/plan/disposal-map.md) · R6)
//!
...
/// # 어휘가 열거인 이유
///
/// [DESIGN §8](../../../docs/plan/disposal-map.md) 이 사유 아홉을 **낱말로** 적었다. 문자열로 두면
