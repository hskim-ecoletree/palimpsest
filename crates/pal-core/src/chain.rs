...
//! 적었는데 타입이 없던 것이다([DESIGN §1.1](../../../docs/DESIGN.md) D26).
//!
...
//! (DESIGN §2.1) 줄 번호는 포매팅으로 움직인다. 줄 위에서 결박하면 [R-07] 이 지목한
...
///
/// [DESIGN §1.1](../../../docs/DESIGN.md)은 `Actor` 를 `{종류, 안정 식별자, 표시 이름}`
...
/// 둘을 한 노드에 넣으면 [§3.4](../../../docs/DESIGN.md)의 속성 출처 동질성이 깨지고,
...
/// 변경 하나 — **[DESIGN §12.6](../../../docs/DESIGN.md)이 "변경의 1급화"를 수입한다고
/// 적고 타입을 만들지 않았던 자리다.**
///
/// **[graph-node] `Change`** — `schema/graph.toml`
///
/// [F23](../../../docs/plan/features/F23-git-integration.md)의 git 결합과
/// [F20](../../../docs/plan/features/F20-conformance-governance.md)의 델타가 전부 이
...
///
/// [DESIGN §1.1](../../../docs/DESIGN.md)은 `{서술, 발현 좌표[], 원인 좌표[], 도입
...
/// [§3.1](../../../docs/DESIGN.md)은 그런 필드를 두지 말라고 적었다 —
...
/// **통째로 담기지 않는다.**
///
/// [F22 §4](../../../docs/plan/features/F22-graph-schema.md)는 그 자리를
...
///
/// 백서 §7 사슬의 `여정` 이고 U11-c 가 *"사용자 여정 추적"* 을 명시 요구했다. 그런데
