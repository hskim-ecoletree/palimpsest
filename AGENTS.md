...
단일 컨텍스트 — 루트의 `CONTEXT.md` + `docs/adr/`. **`CONTEXT.md` 는 아직 없고 없는 것이 정상 상태다.** ADR 은 **열일곱** 있다(F22·F01·F02·F03·F05·F06·F09·F10·F10-5·**F10-6** 종료 시 발행). `docs/agents/domain.md` 참조.
