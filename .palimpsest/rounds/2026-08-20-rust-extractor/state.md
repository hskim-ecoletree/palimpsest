...
**§7 독립 리뷰 — 상한 5 소진.** 다섯 라운드 전부 처분했다.

★ **CI 를 한 번 받았으나 그 뒤 커밋이 나왔다.** §11-6 은 「회차의 **마지막** 커밋
SHA」를 요구하므로 **push 하고 다시 재야 한다.** `cancel-in-progress: true` 라
나눠 올리면 앞 런이 죽는다 — **한 번에 올린다.**
