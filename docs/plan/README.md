...
> 회차가 쓴다**([처리 방침 표](disposal-map.md)).
>
...
| **완성되면 실제로 어떻게 쓰이나** | ⏳ **비었다** — 옛 완성 장면은 MCP 를 전제해 2026-08-18 에 지웠다([처리 방침 표](disposal-map.md)) |
...
| **각 기능을 어떻게 만드나** | ⏳ **비었다** — 판정이 커밋된 것은 [`../gates/`](../gates/) 가, 안 만든 것의 능력은 [00-goals §2.5](00-goals.md) 가 진다([처리 방침 표](disposal-map.md)) |
