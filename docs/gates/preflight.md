...
[`t2-items/01.md`](../../corpus/tasks/t2-items/01.md)부터 33까지 **한 번에 한 파일**을 열고,
답과 소요 초를 [`label-judgment-sheet.md`](../../corpus/tasks/label-judgment-sheet.md)에 적는다.
채우는 규칙(순서 고정 · 건당 초 · 정답 키 열지 않기)이 그 문서에 있다.

**T2는 순수 기준선으로 돌린다**([소유자 판단 §3](../instructions/2026-08-11-owner-direction.md#3--t2는-순수-기준선으로만)) —
절감 장치를 켜지 않는다. 그 효과는 T3가 별도 표본으로 잰다. 33건에서 층을 또 가르면
학습 효과와 장치 효과를 가를 수 없다.
