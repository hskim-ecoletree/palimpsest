...
| T2 라벨 판정 30건 | **통과** — 건당 중앙값 22.9초 | [§T2](#t2--라벨-판정-30건) |
| T3 절감 장치 넷의 분리 측정 | **대조 불가** — 드리프트 0.05. 기준선이 무너져 넷을 가르지 못했다 | [§T3](#t3--단가-절감-장치-넷의-분리-측정) |
...
**42/42 완주했다. 그런데 이 회차가 실제로 잰 것은 장치가 아니라 학습이다.**
