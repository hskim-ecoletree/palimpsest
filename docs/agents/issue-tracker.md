...
- **`/wayfinder`** — 다중 세션 규모를 결정 티켓 지도로 그리는 스킬. ⏳ **지금은 그 지도가 비어 있다** — 옛 지형은 2026-08-18 에 걷어냈고 새 지형은 다음 회차가 쓴다([처분표](../plan/disposal-map.md)). **그때도 실행하지 않는다** — 지도를 만드는 것은 회차의 일이지 명령의 일이 아니다.
